...
class NutrientDataSerializer(serializers.ModelSerializer):
	class Meta:
		model 			= NutrientData
		fields 			= ("food","nutrient","ounce","data_points","error","data_type","derivation","food_reference","added_nutrient","studies","minimum_value","maximum_value","degrees_of_freedom","lower_error_bound","uppper_error_bound","statistical_comments","last_modified","confidence_code")
...
class FoodSerializer(serializers.ModelSerializer):
	class Meta:
		model 			= Food
		fields 			= ("id","food_group","long_description","short_description","name","manufacturer_name","survey","refuse_description","refuse_percentage","scientific_name","n_factor","pro_factor","fat_factor","cho_factor")
...
class FoodViewSet(viewsets.ModelViewSet):
	...
	filter_fields 		= ("id")
	search_fields 		= ("long_description", "short_description", "name", "manufacturer_name")
...
class WeightSerializer(serializers.ModelSerializer):
	class Meta:
		model 			= Weight
		fields 			= ("food","sequence","amount","name","grams","data_points","standard_derivation")
...
class DataSourceSerializer(serializers.ModelSerializer):
	class Meta:
		model 			= DataSource
		fields 			= ("id","authors","name","year","journal","volume","issue_state","start_page","end_page")
...
class NutrientDataInfoSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model 			= NutrientData
		fields 			= ("nutrient","ounce","data_points","error","data_type","derivation","food_reference","added_nutrient","studies","minimum_value","maximum_value","degrees_of_freedom","lower_error_bound","uppper_error_bound","statistical_comments","last_modified","confidence_code")
...
class FoodInfoSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model 			= Food
		fields 			= ("id","food_group","long_description","short_description","name","manufacturer_name","survey","refuse_description","refuse_percentage","scientific_name","n_factor","pro_factor","fat_factor","cho_factor", 'footnote_set', 'nutrientdata_set', 'weight_set', 'foodlangualfactor_set', 'datalink_set')
